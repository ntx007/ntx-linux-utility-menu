...
- AI: Gemini CLI and Claude Code installers plus Node.js v22 install/check helpers
...
- **Operations**
  ...
  - AI/Gemini: install Node.js v22, check Node.js v22, install Gemini CLI, install Claude Code
