...
- UI: grouped main menu (Core / Operations / Shortcuts) with header info (host, threads, RAM, LAN/WAN IP with a quick timeout, distro/OS version/package manager) and update notice; language toggle `d` (en/de).
...
- AI tools: Gemini CLI and Claude Code installers, Gemini API key export, plus Node.js v22 check/install helpers
...
- **Operations**
  ...
  - AI tools: check Node.js v22, install Node.js v22, install Gemini CLI, set Gemini API key, install Claude Code
